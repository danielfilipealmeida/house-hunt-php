...
CREATE TABLE `search_result` (
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_CA88AE0C650760A9` (`search_id`),
  CONSTRAINT `FK_CA88AE0C650760A9` FOREIGN KEY (`search_id`) REFERENCES `search` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2019-05-26 22:40:35
